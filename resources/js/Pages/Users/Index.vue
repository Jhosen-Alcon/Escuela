                    ...
                    <div class="modal-body">
                        <form class="forms-sample">
                            <div class="form-group">
                                ...
                                <code v-if="errors.rol_id" v-text="errors.rol_id[0]"></code>
                            </div>
                            <div class="form-group">
...
<script setup>
    ...
    const titleForm = ref('Registrar Usuario')
    ...
    const initForm = () =>{
        ...
        errors.value = {}
        titleForm.value = 'Registrar usuarios';
    }
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/users/fetchDataTable');
    ...
    const fetchDataById = async (id) => {
        try {
            ...
            titleForm.value = 'Editar usuarios';
            return response.data;
        } catch (error) {
            console.error('Error al obtener datos de la API:', error);
            return [];
        ...
        try {
            ...
            $('#myDataTable').DataTable({
                ...
                initComplete: function () {
                    $('#myDataTable thead').html('<tr><th>ID</th><th>Nombre</th><th>Correo</th><th>Rol</th><th>Estado</th><th>Opciones</th></tr>');
                }
            });
    ...
    const fechAllRoles = async () => {
        const response = await axios.get('/roles/fetchAll');
